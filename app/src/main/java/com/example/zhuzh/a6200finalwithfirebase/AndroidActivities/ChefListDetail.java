...
public class ChefListDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chef_list_detail);
        ...
        ChefListDetail.ItemAdapter itemAdapter = new ChefListDetail.ItemAdapter();
